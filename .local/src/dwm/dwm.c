...
runAutostart(void) {
        ...
        system("xrdb /home/medo/.Xresources");
        system("wal -i files/images/wallpapers/pattern/circles.jpg -qe");
        system("xmodmap -e 'clear Lock' -e 'keycode 0x42 = Escape'");
        system("xinput disable 'ETPS/2 Elantech Touchpad'");
